...
public class EventDAOImpl implements EventDAO{
    ...
    @Override
    public List<Event> mainEvent() throws Exception {
        return sqlSession.selectList("event.mainEvent");
    }
    @Override
    public List<Event> indexEvent() throws Exception {
        return sqlSession.selectList("event.indexEvent");
    }
}
