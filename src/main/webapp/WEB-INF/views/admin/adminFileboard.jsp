      ...
      <div class="columns">
        ...
        <div class="row column text-center">
          ...
          <div class="container">
            <div>
              <%--자료실 --%>
              <table class="table" id="file-table" width="100%">
                <thead>
                <tr>
                  <th class="has-text-centered"  width="15%">번호</th>
                  <th width="40%">제목</th>
                  <th class="has-text-centered"  width="15%">작성자</th>
                  <th class="has-text-centered"  width="15%">작성일</th>
                  <th class="has-text-centered"  width="15%">삭제</th>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${fileboardList}" var="fileboard" varStatus="status">
                  <tr>
                    <td class="has-text-centered" >${fileboard.articleno}</td>
                    <td><a href="${path}/fileboard/detail.do?articleno=${fileboard.articleno}"
                           style="color: #000000;">${fileboard.title}</a></td>
                    <td class="has-text-centered" >${fileboard.id}</td>
                    ...
                    <td class="has-text-centered" >
                      <div class="button-group" style="align-items: center">
                        <a class="button is-danger"
                           href="${path}/fileboard/delete.do?articleno=${fileboard.articleno}" style="height: 20px;">삭제</a>
                      </div>
                    </td>
                  </tr>
                </c:forEach>
