...
INSERT INTO MEMBER
VALUES('kimbk', '1234', '김보경', 'kimbk@edu.com', '01011111111', NULL, NULL, NULL, DEFAULT, '2000-01-01', DEFAULT, DEFAULT);

UPDATE MEMBER SET pw='$2a$10$XEnDzYcntJSrNaDWFi7i0ezf/hxsHCX70re2I1SZ7UWZgk6i5a/ge' WHERE id = 'admin';
UPDATE MEMBER SET pw='$2a$10$XEnDzYcntJSrNaDWFi7i0ezf/hxsHCX70re2I1SZ7UWZgk6i5a/ge' WHERE id = 'kimbk';
